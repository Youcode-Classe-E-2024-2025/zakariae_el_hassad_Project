...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <style>
      .truncate-text {
        display: -webkit-box;
        -webkit-line-clamp: 3; /* Nعرض 3 أسطر فقط */
          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">add project</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex iteqddms-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="cards.html"
              >
                <svg
                  class="w-5 h-5"
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                ...
                >
                  <h1 class="text-2xl font-bold text-white text-center mb-2">Name</h1>
